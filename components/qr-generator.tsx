      ...
      <div className="bg-emerald-700 text-white p-4 sm:p-6">
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            ...
            <p className="text-emerald-100 text-sm">Generate QR codes for table ordering</p>
          </div>
        </div>
      </div>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="bg-blue-50 p-4 rounded-lg">
                ...
                <ul className="text-sm text-blue-800 space-y-1">
                  <li>• Print this QR code and place it on Table {tableNumber}</li>
                  <li>• Customers can scan the code to order directly from their table</li>
                  <li>• Orders will show "Table {tableNumber}" in the waiter dashboard</li>
                </ul>
              </div>
            </CardContent>
          </Card>
